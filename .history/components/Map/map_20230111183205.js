...
export default function Map() {
    ...
    const burmudaOption = { color: 'brown'};
    ...
    return (
        <MapContainer className={style.map} center={position} zoom={14} scrollWheelZoom={true}>
            ...
            <CircleMarker center={[49.27450, -123.12189]} pathOptions={yellowOption} radius={20}>
                <Popup>You reached your destination</Popup>
            </CircleMarker>

            <Polyline pathOptions={burmudaOption} positions={polyline}/>
        </MapContainer>

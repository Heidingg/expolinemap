...
export default function Map() {
    ...
    //Waterfront to Production Way change from Columbia Skytrain Station
    ...
    const blueOption = { color: 'brown'};
    const orangeOption = { color: 'yellow'};
    ...
    return (
        <MapContainer className={style.map} center={position} zoom={14} scrollWheelZoom={true}>
            ...
            <CircleMarker center={[49.27450, -123.12189]} pathOptions={orangeOption} radius={20}>
